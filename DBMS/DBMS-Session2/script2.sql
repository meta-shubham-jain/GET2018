...
INSERT INTO shopper(shopper_first_name, shopper_last_name, shopper_email_id, date_of_birth, password)
VALUES
    ("Shubham", "Jain", "jain33580@gmail.com", '1994-08-22', "123"),
    ("Rahul", "Jain", "rahul@gmail.com", '1995-06-02', "123"),
    ("Mohit", "Jain", "mohit@gmail.com", '1996-04-12', "123"),
    ("Shyam", "Agarwal", "shyam@gmail.com", "1997-02-22", "321"),
    ("Somi", "Vishnoi", "somi@gmail.com", "1996-01-22", "321");

#Insert data into admin
INSERT INTO admin(admin_first_name, admin_last_name, admin_email_id, date_of_birth, password)
VALUES
    ("Ravi", "Sharma", "ravi33580@gmail.com", '1994-08-22', "123"),
    ("Raj", "Agarwal", "raj@gmail.com", '1995-06-02', "123");
...
INSERT INTO address(house_no,street_no,city,state,country,pincode,phone_no,shopper_id)
VALUES
    ("1",1,"Jodhpur","Rajasthan","India","332001",8094011142,1),
    ("2",1,"Jodhpur","Rajasthan","India","332001",7725962262,1),
    ("3",3,"Panaji","Goa","India","342001",1234567890,2),
    ("1",5,"Jaipur","Rajasthan","India","342001",9876543210,3),
    ("2",1,"Sikar","Rajasthan","India","323001",1357924680,4),
    ("1",3,"Udaipur","Rajasthan","India","321001",1234567890,5);
...
VALUES
    ...
    (11,16,3000,1,"Shipped"),
    (11,17,2000,1,"Shipped"),
    (12,12,6000,4,"Cancel");

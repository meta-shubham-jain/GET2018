...
public class AdminController {
	...
	public String addEmployee(@ModelAttribute("employee") Employee employee) {
		if (employee != null && employee.getEmpCode() == 0) {
			...
			Employee employeeId = employeeService.getEmployeeByEmail(employee.getEmail());
	...
	public String searchEmployeeBySkills(Model model, @RequestParam("skills") String skillId) {
	...
	public String searchEmployeeInProject(Model model, @RequestParam("projectId") int projectId) {
		model.addAttribute("projectList", projectMasterService.getAll());
		model.addAttribute("employees", employeeService.getEmployeesByProject(projectId));
		return "admin/searchEmployeeByProject";
	}

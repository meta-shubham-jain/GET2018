...
public class Triangle implements Shape {
    ...
    Triangle(double height, double base, double side, Point origin,
            Date timeStamp) {
        this.height = height;
        this.base = base;
        this.side = side;
    ...
    void calculateOtherPoints() {
        ...
        double coordinate;
        basePoint = new Point(origin.getXCoordinate() + base,
                origin.getYCoordinate());
        coordinate = basePoint.getYCoordinate() + height;
        xUpperCoordinate = Math.sqrt((side * side)
                - Math.pow(coordinate - origin.getYCoordinate(), 2))
